...
class NewEventForm(FlaskForm):
    ...
    theme = StringField("Event theme color", validators=[validators.DataRequired()])
    event_description = TextAreaField(
        "Description of the event", validators=[validators.DataRequired()]
    )
    image = FileField(
...
class NewItemForm(FlaskForm):
    ...
    name = StringField("Item Name", validators=[validators.DataRequired()])
    item_description = TextAreaField(
        "Description", validators=[validators.DataRequired()]
    )
    image = FileField(
    ...
    link = StringField("Link where to get it from")
